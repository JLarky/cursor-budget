...
tester.run("anti-slop/no-module-mocking", noModuleMockingRule, {
  valid: [
    ...
    "import { mock } from 'node:test'; mock.fn();",
    "const mock = { module() {} }; mock.module('./user-store');",
  ],
  invalid: [
    ...
    {
      code: "import { mock } from 'node:test'; mock.module('./user-store');",
      errors: [error],
    },
    {
      code: "import { mock as nodeMock } from 'node:test'; nodeMock.module('./user-store');",
      errors: [error],
    },
    {
      code: "import * as nodeTest from 'node:test'; nodeTest.mock.module('./user-store');",
      errors: [error],
    },
    {
      code: "function run(t) { t.mock.module('./user-store'); }",
      errors: [error],
    },
  ],
});
